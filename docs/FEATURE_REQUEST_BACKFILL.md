...
| FRB-023 | closed | #23 | Opciones de colores para campos de formulario | 2c22b23 | `docs/FIELD_COLOR_OPTIONS.md` eliminado; contenido convertido en issue #24 | Documenta combinaciones de color para inputs en modo claro y oscuro; la implementacion pendiente vive en #24. |
